...
# Define these to suit your nefarious purposes
              ...
              FRAMEWORK_VERSION=A
       	     ...
       	     PROJECT_FILES_PATH=${PROJECT_DIR}/cocos2d
...
find ${PROJECT_FILES_PATH} -maxdepth 2 -name "*.h" -exec cp {} $FRAMEWORK_DIR/Headers/ \; -print
find ${PROJECT_FILES_PATH}/Platforms/iOS -maxdepth 1 -name "*.h" -exec cp {} $FRAMEWORK_DIR/Headers/ \; -print

#find ${PROJECT_DIR}/${PROJECT}.xcodeproj/project.pbxproj -print0 | xargs -0 grep -oP "\w+\.h" | sort | uniq | xargs -I {} cp -f {} $FRAMEWORK_DIR/Headers/
#find ${PROJECT_DIR}/${PROJECT}/Resources -name "*.png" -exec cp {} $FRAMEWORK_DIR/Resources/ \; -print

cp ${PROJECT_DIR}/Resources/Info.plist $FRAMEWORK_DIR/Resources/Info.plist
